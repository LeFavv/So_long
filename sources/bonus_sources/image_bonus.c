...
void	render_map_number_move_bonus(t_game *game, char *str, int i)
{
	i = 4;
	while (str[i])
	{
		if (str[i] == '0')
			mlx_put_image_to_window(game->mlx, game->win, game->tex_bonus.zero, game->map_width - i * TILE_SIZE, game->map_height * TILE_SIZE);
		if (str[i] == '1')
			mlx_put_image_to_window(game->mlx, game->win, game->tex_bonus.one, game->map_width - i * TILE_SIZE, game->map_height * TILE_SIZE);
		if (str[i] == '2')
			mlx_put_image_to_window(game->mlx, game->win, game->tex_bonus.two, game->map_width - i * TILE_SIZE, game->map_height * TILE_SIZE);
		if (str[i] == '3')
			mlx_put_image_to_window(game->mlx, game->win, game->tex_bonus.three, game->map_width - i * TILE_SIZE, game->map_height * TILE_SIZE);
		if (str[i] == '4')
			mlx_put_image_to_window(game->mlx, game->win, game->tex_bonus.four, game->map_width - i * TILE_SIZE, game->map_height * TILE_SIZE);
		if (str[i] == '5')
			mlx_put_image_to_window(game->mlx, game->win, game->tex_bonus.five, game->map_width - i * TILE_SIZE, game->map_height * TILE_SIZE);
		if (str[i] == '6')
			mlx_put_image_to_window(game->mlx, game->win, game->tex_bonus.six, game->map_width - i * TILE_SIZE, game->map_height * TILE_SIZE);
		if (str[i] == '7')
			mlx_put_image_to_window(game->mlx, game->win, game->tex_bonus.seven, game->map_width - i * TILE_SIZE, game->map_height * TILE_SIZE);
		if (str[i] == '8')
			mlx_put_image_to_window(game->mlx, game->win, game->tex_bonus.eight, game->map_width - i * TILE_SIZE, game->map_height * TILE_SIZE);
		if (str[i] == '9')
			mlx_put_image_to_window(game->mlx, game->win, game->tex_bonus.nine, game->map_width - i * TILE_SIZE, game->map_height * TILE_SIZE);
		i--;
	}
}
